        ...
        <div className="min-h-screen bg-[#Fdfdfd] text-black font-sans selection:bg-purple-200 overflow-x-hidden flex flex-col relative">
            ...
            <main className="flex-1 flex flex-col items-center relative w-full max-w-full mx-auto pt-10 overflow-x-hidden">
                ...
                <div className="text-center space-y-4 mb-8 z-10 relative px-4 mt-20 w-full max-w-7xl">
                    <h1 className="text-[2.2rem] sm:text-[3rem] md:text-[5rem] lg:text-[7rem] leading-1 font-normal tracking-[-0.04em] text-[#1A1A1A] flex flex-wrap justify-center items-center gap-2 md:gap-4">
                        <span>Berkreasi</span>
                ...
                {/* Circular Gallery */}
                <div className="w-full h-[350px] sm:h-[450px] md:h-[600px] relative overflow-hidden">
                    <CircularGallery
                        items={galleryItems}
                        bend={2}
                        textColor="#ffffff"
